...
class TargetUpdate implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the TargetUpdate object to a human-readable string representation.
     *
     * @return string The string representation of the TargetUpdate object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('TargetUpdate', ['id' => $this->id, 'type' => $this->type]);
    }
