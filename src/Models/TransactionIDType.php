 ...
 */
class TransactionIDType implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the TransactionIDType object to a human-readable string representation.
     *
     * @return string The string representation of the TransactionIDType object.
     */
