...
| `bankAccount` | [`?BankAccount1`](../../doc/models/bank-account-1.md) | Optional | The details of the bank account, from which the payment should be made.<br><br>> Either `bankAccount` or `card` field must be provided in a payment request. | getBankAccount(): ?BankAccount1 | setBankAccount(?BankAccount1 bankAccount): void |
...
| `card` | [`?Card3`](../../doc/models/card-3.md) | Optional | A container for card data.<br><br>> Either `bankAccount` or `card` field must be provided in a payment request. | getCard(): ?Card3 | setCard(?Card3 card): void |
...
| `entityType` | [`?string(EntityTypeEnum)`](../../doc/models/entity-type-enum.md) | Optional | The type of the entity the payment is processed for. | getEntityType(): ?string | setEntityType(?string entityType): void |
...
| `fundDestination` | [`?FundDestination1`](../../doc/models/fund-destination-1.md) | Optional | the person or entity receiving the money | getFundDestination(): ?FundDestination1 | setFundDestination(?FundDestination1 fundDestination): void |
| `fundSource` | [`?FundSource1`](../../doc/models/fund-source-1.md) | Optional | The person or entity funding the money. | getFundSource(): ?FundSource1 | setFundSource(?FundSource1 fundSource): void |
...
| `nationality` | `?string` | Optional | The two-character country code of the shopper's nationality.<br><br>**Constraints**: *Maximum Length*: `2` | getNationality(): ?string | setNationality(?string nationality): void |
...
| `secureRemoteCommerceCheckoutData` | [`?SecureRemoteCommerceCheckoutData2`](../../doc/models/secure-remote-commerce-checkout-data-2.md) | Optional | Checkout data for a Secure Remote Commerce payment. | getSecureRemoteCommerceCheckoutData(): ?SecureRemoteCommerceCheckoutData2 | setSecureRemoteCommerceCheckoutData(?SecureRemoteCommerceCheckoutData2 secureRemoteCommerceCheckoutData): void |
...
```php
use AdyenLib\Models\Builders\PaymentRequest1Builder;
...
use AdyenLib\Models\Builders\BankAccount1Builder;

$paymentRequest1 = PaymentRequest1Builder::init(
    AmountBuilder::init(
        'currency2',
        110
    )->build(),
