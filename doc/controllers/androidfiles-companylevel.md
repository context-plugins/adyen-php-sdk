...
try {
    $result = $androidFilesCompanyLevelApi->getCompaniesCompanyIdAndroidApps($companyId);
...
```php
function postCompaniesCompanyIdAndroidApps(string $companyId): UploadAndroidAppResponse
```
...
try {
    $result = $androidFilesCompanyLevelApi->postCompaniesCompanyIdAndroidApps($companyId);
...
```php
function getCompaniesCompanyIdAndroidAppsId(string $companyId, string $id): AndroidApp
```
...
try {
    $result = $androidFilesCompanyLevelApi->getCompaniesCompanyIdAndroidAppsId(
        $companyId,
        $id
    );
    echo 'AndroidApp:';
...
```php
function patchCompaniesCompanyIdAndroidAppsId(string $companyId, string $id): ReprocessAndroidAppResponse
```
...
try {
    $result = $androidFilesCompanyLevelApi->patchCompaniesCompanyIdAndroidAppsId(
        $companyId,
        $id
    );
...
try {
    $result = $androidFilesCompanyLevelApi->getCompaniesCompanyIdAndroidCertificates($companyId);
...
```php
function postCompaniesCompanyIdAndroidCertificates(string $companyId): UploadAndroidCertificateResponse
```
...
try {
    $result = $androidFilesCompanyLevelApi->postCompaniesCompanyIdAndroidCertificates($companyId);
