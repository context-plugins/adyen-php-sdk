...
class AdyenClientBuilder
{
    ...
    public function clientKeyCredentials(ClientKeyCredentialsBuilder $clientKey): self
    {
        $this->config = array_merge($this->config, $clientKey->getConfiguration());
        return $this;
    }
    ...
    public function build(): AdyenClient
    {
        return new AdyenClient($this->config);
    }
}
