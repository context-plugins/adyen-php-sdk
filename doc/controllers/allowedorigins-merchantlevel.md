...
try {
    $result = $allowedOriginsMerchantLevelApi->getMerchantsMerchantIdApiCredentialsApiCredentialIdAllowedOrigins(
        $merchantId,
        $apiCredentialId
    );
...
try {
    $result = $allowedOriginsMerchantLevelApi->postMerchantsMerchantIdApiCredentialsApiCredentialIdAllowedOrigins(
        $merchantId,
        $apiCredentialId,
        $body
    );
...
try {
    $result = $allowedOriginsMerchantLevelApi->getMerchantsMerchantIdApiCredentialsApiCredentialIdAllowedOriginsOriginId(
        $merchantId,
        $apiCredentialId,
        $originId
    );
