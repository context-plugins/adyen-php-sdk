...
```php
function getTerminalsTerminalIdTerminalLogos(string $terminalId): Logo
```
...
try {
    $result = $terminalSettingsTerminalLevelApi->getTerminalsTerminalIdTerminalLogos($terminalId);
    echo 'Logo:';
    var_dump($result);
...
```php
function patchTerminalsTerminalIdTerminalLogos(string $terminalId, ?Logo $body = null): Logo
```
...
try {
    $result = $terminalSettingsTerminalLevelApi->patchTerminalsTerminalIdTerminalLogos(
        $terminalId,
        $body
    );
    echo 'Logo:';
...
```php
function getTerminalsTerminalIdTerminalSettings(string $terminalId): TerminalSettings
```
...
try {
    $result = $terminalSettingsTerminalLevelApi->getTerminalsTerminalIdTerminalSettings($terminalId);
...
try {
    $result = $terminalSettingsTerminalLevelApi->patchTerminalsTerminalIdTerminalSettings(
        $terminalId,
        $body
    );
    echo 'TerminalSettings:';
