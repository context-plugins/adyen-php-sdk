...
class TokenMandate2 implements \JsonSerializable
{
     ...
     *
     * @maps amountRule
     * @factory \AdyenLib\Models\AmountRuleEnum::checkValue
     */
     ...
     * @factory \AdyenLib\Models\BillingAttemptsRuleEnum::checkValue
     */
     ...
     * @required
     * @maps frequency
     * @factory \AdyenLib\Models\FrequencyEnum::checkValue
     */
     ...
     */
    public function setRecurringAmount(?string $recurringAmount): void
    {
     ...
     * The text that will be shown on the shopper's bank statement for the recurring payments. We recommend
     * to add a descriptive text about the subscription to let your shoppers recognize your recurring
     * payments.
     ...
     */
    public function getRetryPolicy(): ?string
    {
     ...
     *
     * @maps retryPolicy
     * @factory \AdyenLib\Models\RetryPolicyEnum::checkValue
     */
    public function setRetryPolicy(?string $retryPolicy): void
    {
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->amountRule)) {
            $json['amountRule']          = AmountRuleEnum::checkValue($this->amountRule);
        }
        if (isset($this->billingAttemptsRule)) {
            $json['billingAttemptsRule'] = BillingAttemptsRuleEnum::checkValue($this->billingAttemptsRule);
        }
        ...
        if (isset($this->retryPolicy)) {
            $json['retryPolicy']         = RetryPolicyEnum::checkValue($this->retryPolicy);
        }
