...
try {
    $result = $aPICredentialsCompanyLevelApi->getCompaniesCompanyIdApiCredentials($companyId);
...
try {
    $result = $aPICredentialsCompanyLevelApi->postCompaniesCompanyIdApiCredentials(
        $companyId,
        $body
    );
...
try {
    $result = $aPICredentialsCompanyLevelApi->getCompaniesCompanyIdApiCredentialsApiCredentialId(
        $companyId,
        $apiCredentialId
    );
...
try {
    $result = $aPICredentialsCompanyLevelApi->patchCompaniesCompanyIdApiCredentialsApiCredentialId(
        $companyId,
        $apiCredentialId,
        $body
    );
