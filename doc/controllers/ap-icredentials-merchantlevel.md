...
try {
    $result = $aPICredentialsMerchantLevelApi->getMerchantsMerchantIdApiCredentials($merchantId);
...
try {
    $result = $aPICredentialsMerchantLevelApi->postMerchantsMerchantIdApiCredentials(
        $merchantId,
        $body
    );
...
try {
    $result = $aPICredentialsMerchantLevelApi->getMerchantsMerchantIdApiCredentialsApiCredentialId(
        $merchantId,
        $apiCredentialId
    );
    echo 'ApiCredential:';
...
try {
    $result = $aPICredentialsMerchantLevelApi->patchMerchantsMerchantIdApiCredentialsApiCredentialId(
        $merchantId,
        $apiCredentialId,
        $body
    );
