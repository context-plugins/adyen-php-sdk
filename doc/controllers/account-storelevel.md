...
try {
    $result = $accountStoreLevelApi->getMerchantsMerchantIdStores($merchantId);
...
```php
function postMerchantsMerchantIdStores(string $merchantId, ?StoreCreationRequest $body = null): Store
```
...
try {
    $result = $accountStoreLevelApi->postMerchantsMerchantIdStores(
        $merchantId,
        $body
    );
    echo 'Store:';
...
```php
function getMerchantsMerchantIdStoresStoreId(string $merchantId, string $storeId): Store
```
...
try {
    $result = $accountStoreLevelApi->getMerchantsMerchantIdStoresStoreId(
        $merchantId,
        $storeId
    );
    echo 'Store:';
...
try {
    $result = $accountStoreLevelApi->patchMerchantsMerchantIdStoresStoreId(
        $merchantId,
        $storeId,
        $body
    );
...
try {
    $result = $accountStoreLevelApi->getStores();
    echo 'ListStoresResponse:';
    var_dump($result);
} catch (RestServiceErrorException $exp) {
    echo 'Caught RestServiceErrorException:', $exp;
...
```php
function postStores(?StoreCreationWithMerchantCodeRequest $body = null): Store
```
...
try {
    $result = $accountStoreLevelApi->postStores($body);
    echo 'Store:';
    var_dump($result);
} catch (RestServiceErrorException $exp) {
    echo 'Caught RestServiceErrorException:', $exp;
...
```php
function getStoresStoreId(string $storeId): Store
```
...
try {
    $result = $accountStoreLevelApi->getStoresStoreId($storeId);
    echo 'Store:';
    var_dump($result);
} catch (RestServiceErrorException $exp) {
    echo 'Caught RestServiceErrorException:', $exp;
...
```php
function patchStoresStoreId(string $storeId, ?UpdateStoreRequest $body = null): Store
```
...
try {
    $result = $accountStoreLevelApi->patchStoresStoreId(
        $storeId,
        $body
    );
    echo 'Store:';
