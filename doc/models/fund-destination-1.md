...
```php
use AdyenLib\Models\Builders\FundDestination1Builder;
use AdyenLib\Models\Builders\AddressBuilder;
use AdyenLib\Models\Builders\Card1Builder;

$fundDestination1 = FundDestination1Builder::init()
    ->iBAN('IBAN0')
    ->additionalData(
        [
    ...
    ->selectedRecurringDetailReference('selectedRecurringDetailReference4')
    ->build();
```
