...
```php
use AdyenLib\Models\Builders\CheckoutSessionThreeDS2RequestDataBuilder;
...
$checkoutSessionThreeDS2RequestData = CheckoutSessionThreeDS2RequestDataBuilder::init()
    ->homePhone(
        Phone3Builder::init()
            ->cc('cc0')
