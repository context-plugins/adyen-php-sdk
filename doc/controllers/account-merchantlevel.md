...
```php
function getMerchants(?int $pageNumber = null, ?int $pageSize = null): ListMerchantResponse
```
...
try {
    $result = $accountMerchantLevelApi->getMerchants();
...
```php
function postMerchants(?CreateMerchantRequest $body = null): CreateMerchantResponse
```
...
try {
    $result = $accountMerchantLevelApi->postMerchants($body);
...
```php
function getMerchantsMerchantId(string $merchantId): Merchant
```
...
try {
    $result = $accountMerchantLevelApi->getMerchantsMerchantId($merchantId);
    echo 'Merchant:';
    var_dump($result);
} catch (RestServiceErrorException $exp) {
    echo 'Caught RestServiceErrorException:', $exp;
...
```php
function postMerchantsMerchantIdActivate(string $merchantId): RequestActivationResponse
```
...
try {
    $result = $accountMerchantLevelApi->postMerchantsMerchantIdActivate($merchantId);
