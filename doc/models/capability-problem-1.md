...
|  --- | --- | --- | --- | --- | --- |
| `entity` | [`?CapabilityProblemEntity1`](../../doc/models/capability-problem-entity-1.md) | Optional | - | getEntity(): ?CapabilityProblemEntity1 | setEntity(?CapabilityProblemEntity1 entity): void |
| `verificationErrors` | [`?(VerificationError1[])`](../../doc/models/verification-error-1.md) | Optional | - | getVerificationErrors(): ?array | setVerificationErrors(?array verificationErrors): void |
...
$capabilityProblem1 = CapabilityProblem1Builder::init()
    ->entity(
