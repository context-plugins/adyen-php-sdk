...
```php
use AdyenLib\Models\Builders\CheckoutBankAccount1Builder;
use AdyenLib\Models\AccountType1Enum;

$checkoutBankAccount1 = CheckoutBankAccount1Builder::init()
    ->accountType(AccountType1Enum::SAVINGS)
    ->bankAccountNumber('bankAccountNumber6')
    ->bankCity('bankCity2')
    ->bankLocationId('bankLocationId0')
    ->bankName('bankName8')
    ->build();
```
