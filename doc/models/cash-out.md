...
| `id` | `string` | Required | The unique identifier of the cashout reference. | getId(): string | setId(string id): void |
...
| `transfers` | [`CashOutTransfer[]`](../../doc/models/cash-out-transfer.md) | Required | The list of transfers related to cashout. | getTransfers(): array | setTransfers(array transfers): void |

## Example

```php
use AdyenLib\Models\Builders\CashOutBuilder;
