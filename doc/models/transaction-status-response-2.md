...
| `messageReference` | [`?MessageReference3`](../../doc/models/message-reference-3.md) | Optional | Identification of a previous POI transaction.<br>If `Response.Result` is Success. | getMessageReference(): ?MessageReference3 | setMessageReference(?MessageReference3 messageReference): void |
| `repeatedMessageResponse` | [`?RepeatedMessageResponse2`](../../doc/models/repeated-message-response-2.md) | Optional | Content of the requested Message Response.<br>If Result is Success (process completed). | getRepeatedMessageResponse(): ?RepeatedMessageResponse2 | setRepeatedMessageResponse(?RepeatedMessageResponse2 repeatedMessageResponse): void |

## Example

```php
use AdyenLib\Models\Builders\TransactionStatusResponse2Builder;
...
use AdyenLib\Models\Builders\RepeatedMessageResponse2Builder;
...
$transactionStatusResponse2 = TransactionStatusResponse2Builder::init(
    ...
    ->repeatedMessageResponse(
        RepeatedMessageResponse2Builder::init(
