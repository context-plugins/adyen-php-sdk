...
```php
use AdyenLib\Models\Builders\MerchantRiskIndicator1Builder;
use AdyenLib\Models\DeliveryAddressIndicatorEnum;
use AdyenLib\Models\DeliveryTimeframeEnum;

$merchantRiskIndicator1 = MerchantRiskIndicator1Builder::init()
    ->addressMatch(false)
    ->deliveryAddressIndicator(DeliveryAddressIndicatorEnum::SHIPTOBILLINGADDRESS)
