...
```php
use AdyenLib\Models\Builders\CreateCompanyApiCredentialResponseBuilder;
...
$createCompanyApiCredentialResponse = CreateCompanyApiCredentialResponseBuilder::init(
    false,
    [
        'allowedIpAddresses7',
        'allowedIpAddresses6',
