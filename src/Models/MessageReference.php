 ...
 * status.
 */
class MessageReference implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the MessageReference object to a human-readable string representation.
     *
     * @return string The string representation of the MessageReference object.
     */
