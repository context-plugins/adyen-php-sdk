...
class CreateOrderRequest implements \JsonSerializable
{
     ...
     */
    public function __construct(Amount21 $amount, string $merchantAccount, string $reference)
    {
        $this->amount = $amount;
     ...
     */
    public function getAmount(): Amount21
    {
        return $this->amount;
    }
     ...
     * @maps amount
     */
    public function setAmount(Amount21 $amount): void
    {
        $this->amount = $amount;
    }
