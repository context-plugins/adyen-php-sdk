...
class FundSource implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the FundSource object to a human-readable string representation.
     *
     * @return string The string representation of the FundSource object.
     */
