...
```php
use AdyenLib\Models\Builders\ListMerchantApiCredentialsResponseBuilder;
...
use AdyenLib\Models\Builders\ApiCredentialBuilder;
...
$listMerchantApiCredentialsResponse = ListMerchantApiCredentialsResponseBuilder::init(
    126,
    88
)
    ->links(
