...
| `type` | [`?string(Type310Enum)`](../../doc/models/type-310-enum.md) | Optional | **bank**<br><br>**Default**: `Type310Enum::BANK` | getType(): ?string | setType(?string type): void |
...
$bankCategoryData = BankCategoryDataBuilder::init()
