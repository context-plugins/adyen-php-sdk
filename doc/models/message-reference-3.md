...
```php
use AdyenLib\Models\Builders\MessageReference3Builder;
use AdyenLib\Models\MessageCategory2Enum;

$messageReference3 = MessageReference3Builder::init()
    ->messageCategory(MessageCategory2Enum::BALANCEINQUIRY)
