...
try {
    $result = $webhooksCompanyLevelApi->getCompaniesCompanyIdWebhooks($companyId);
...
```php
function postCompaniesCompanyIdWebhooks(string $companyId, ?CreateCompanyWebhookRequest $body = null): Webhook
```
...
$body = CreateCompanyWebhookRequestBuilder::init(
    ...
    FilterMerchantAccountTypeEnum::INCLUDEACCOUNTS,
    [
...
try {
    $result = $webhooksCompanyLevelApi->postCompaniesCompanyIdWebhooks(
        $companyId,
        $body
    );
    echo 'Webhook:';
...
```php
function getCompaniesCompanyIdWebhooksWebhookId(string $companyId, string $webhookId): Webhook
```
...
try {
    $result = $webhooksCompanyLevelApi->getCompaniesCompanyIdWebhooksWebhookId(
        $companyId,
        $webhookId
    );
    echo 'Webhook:';
...
```php
function deleteCompaniesCompanyIdWebhooksWebhookId(string $companyId, string $webhookId): void
```
...
try {
    $webhooksCompanyLevelApi->deleteCompaniesCompanyIdWebhooksWebhookId(
        $companyId,
        $webhookId
    );
} catch (RestServiceErrorException $exp) {
...
try {
    $result = $webhooksCompanyLevelApi->patchCompaniesCompanyIdWebhooksWebhookId(
        $companyId,
        $webhookId,
        $body
    );
...
```php
function postCompaniesCompanyIdWebhooksWebhookIdGenerateHmac(
    string $companyId,
    string $webhookId
...
try {
    $result = $webhooksCompanyLevelApi->postCompaniesCompanyIdWebhooksWebhookIdGenerateHmac(
        $companyId,
        $webhookId
    );
...
try {
    $result = $webhooksCompanyLevelApi->postCompaniesCompanyIdWebhooksWebhookIdTest(
        $companyId,
        $webhookId,
        $body
    );
