 ...
 * `registeredAddress`.
 */
class Address41 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the Address41 object to a human-readable string representation.
     *
     * @return string The string representation of the Address41 object.
     */
