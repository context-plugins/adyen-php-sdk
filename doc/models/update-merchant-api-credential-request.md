...
```php
use AdyenLib\Models\Builders\UpdateMerchantApiCredentialRequestBuilder;

$updateMerchantApiCredentialRequest = UpdateMerchantApiCredentialRequestBuilder::init()
    ->active(false)
    ->allowedOrigins(
        [
            'allowedOrigins4',
