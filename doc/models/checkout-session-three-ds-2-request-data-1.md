...
```php
use AdyenLib\Models\Builders\CheckoutSessionThreeDS2RequestData1Builder;
...
$checkoutSessionThreeDS2RequestData1 = CheckoutSessionThreeDS2RequestData1Builder::init()
    ->homePhone(
        Phone3Builder::init()
            ->cc('cc0')
    ...
    ->threeDSRequestorChallengeInd(ThreeDSRequestorChallengeIndEnum::ENUM_05)
    ->workPhone(
        Phone2Builder::init()
            ->cc('cc2')
