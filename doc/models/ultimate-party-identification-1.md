...
| `fundingInstrument` | [`?FundingInstrument2`](../../doc/models/funding-instrument-2.md) | Optional | Details of the card or token used to fund the pay-in transaction. | getFundingInstrument(): ?FundingInstrument2 | setFundingInstrument(?FundingInstrument2 fundingInstrument): void |
...
```php
use AdyenLib\Models\Builders\UltimatePartyIdentification1Builder;
use AdyenLib\Models\Builders\Address12Builder;
use AdyenLib\Utils\DateTimeHelper;
use AdyenLib\Models\Type112Enum;

$ultimatePartyIdentification1 = UltimatePartyIdentification1Builder::init()
    ->address(
