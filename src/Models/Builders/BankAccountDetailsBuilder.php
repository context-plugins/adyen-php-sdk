...
use AdyenLib\Models\BankAccountDetails;
use Core\Utils\CoreHelper;

/**
 * Builder for model BankAccountDetails
 *
...
class BankAccountDetailsBuilder
{
    ...
    private function __construct(BankAccountDetails $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Bank Account Details Builder object.
     *
     * @param string $type
     */
    public static function init(string $type): self
    {
        return new self(new BankAccountDetails($type));
    }
    ...
    /**
     * Initializes a new Bank Account Details object.
     */
    public function build(): BankAccountDetails
    {
