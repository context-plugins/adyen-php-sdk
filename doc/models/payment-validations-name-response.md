...
```php
use AdyenLib\Models\Builders\PaymentValidationsNameResponseBuilder;
...
$paymentValidationsNameResponse = PaymentValidationsNameResponseBuilder::init()
    ->rawResponse(
    ...
    ->status(StatusEnum::NOTSUPPORTED)
    ->build();
```
