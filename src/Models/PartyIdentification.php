...
class PartyIdentification implements \JsonSerializable
{
    ...
    /**
     * Converts the PartyIdentification object to a human-readable string representation.
     *
     * @return string The string representation of the PartyIdentification object.
     */
