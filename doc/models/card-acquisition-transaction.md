...
```php
use AdyenLib\Models\Builders\CardAcquisitionTransactionBuilder;
use AdyenLib\Models\LoyaltyHandling2Enum;
use AdyenLib\Models\ForceEntryModeEnum;

$cardAcquisitionTransaction = CardAcquisitionTransactionBuilder::init()
    ->allowedPaymentBrand(
        [
