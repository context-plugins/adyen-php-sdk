...
```php
use AdyenLib\Models\Builders\MerchantRiskIndicatorBuilder;
use AdyenLib\Models\DeliveryAddressIndicatorEnum;
use AdyenLib\Models\DeliveryTimeframeEnum;

$merchantRiskIndicator = MerchantRiskIndicatorBuilder::init()
    ->addressMatch(false)
    ->deliveryAddressIndicator(DeliveryAddressIndicatorEnum::DIGITALGOODS)
