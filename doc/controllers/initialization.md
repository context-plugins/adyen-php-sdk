...
```php
$initializationApi = $client->getInitializationApi();
```
...
```php
function postStoreDetail(?StoreDetailRequest $body = null): StoreDetailResponse
```
...
try {
    $result = $initializationApi->postStoreDetail();
    echo 'StoreDetailResponse:';
    var_dump($result);
...
```php
function postStoreDetailAndSubmitThirdParty(
...
try {
    $result = $initializationApi->postStoreDetailAndSubmitThirdParty();
    echo 'StoreDetailAndSubmitResponse:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
} catch (ApiException $exp) {
...
```php
function postSubmitThirdParty(?SubmitRequest $body = null): SubmitResponse
```
...
try {
    $result = $initializationApi->postSubmitThirdParty();
    echo 'SubmitResponse:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
