...
|  --- | --- | --- | --- | --- | --- |
| `balancePlatformPayoutScheduleId` | `string` | Required | The unique identifier of the payout schedule that is applied to the balance account. | getBalancePlatformPayoutScheduleId(): string | setBalancePlatformPayoutScheduleId(string balancePlatformPayoutScheduleId): void |
...
```php
use AdyenLib\Models\Builders\BalanceAccountConfigurationRequestBuilder;
use AdyenLib\Models\Frequency1Enum;

$balanceAccountConfigurationRequest = BalanceAccountConfigurationRequestBuilder::init(
    'balancePlatformPayoutScheduleId4',
    Frequency1Enum::WEEKDAYS,
