...
```php
function getMerchantsMerchantIdPayoutSettings(string $merchantId): PayoutSettingsResponse
```
...
try {
    $result = $payoutSettingsMerchantLevelApi->getMerchantsMerchantIdPayoutSettings($merchantId);
...
try {
    $result = $payoutSettingsMerchantLevelApi->postMerchantsMerchantIdPayoutSettings($merchantId);
    echo 'PayoutSettings:';
    var_dump($result);
} catch (RestServiceErrorException $exp) {
    echo 'Caught RestServiceErrorException:', $exp;
...
try {
    $result = $payoutSettingsMerchantLevelApi->getMerchantsMerchantIdPayoutSettingsPayoutSettingsId(
        $merchantId,
        $payoutSettingsId
    );
    echo 'PayoutSettings:';
...
try {
    $payoutSettingsMerchantLevelApi->deleteMerchantsMerchantIdPayoutSettingsPayoutSettingsId(
        $merchantId,
        $payoutSettingsId
    );
} catch (RestServiceErrorException $exp) {
...
try {
    $result = $payoutSettingsMerchantLevelApi->patchMerchantsMerchantIdPayoutSettingsPayoutSettingsId(
        $merchantId,
        $payoutSettingsId
    );
    echo 'PayoutSettings:';
