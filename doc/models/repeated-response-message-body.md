...
|  --- | --- | --- | --- | --- | --- |
| `loyaltyResponse` | [`?LoyaltyResponse`](../../doc/models/loyalty-response.md) | Optional | It conveys Information related to the Loyalty transaction processed by the POI System.<br>Content of the Loyalty Response message. | getLoyaltyResponse(): ?LoyaltyResponse | setLoyaltyResponse(?LoyaltyResponse loyaltyResponse): void |
| `paymentResponse` | [`?PaymentResponse4`](../../doc/models/payment-response-4.md) | Optional | It conveys Information related to the Payment transaction processed by the POI System.<br>Content of the Payment Response message. | getPaymentResponse(): ?PaymentResponse4 | setPaymentResponse(?PaymentResponse4 paymentResponse): void |
| `reversalResponse` | [`?ReversalResponse`](../../doc/models/reversal-response.md) | Optional | It conveys Information related to the reversal processed by the POI System.<br>Content of the Reversal Response message. | getReversalResponse(): ?ReversalResponse | setReversalResponse(?ReversalResponse reversalResponse): void |
| `storedValueResponse` | [`?StoredValueResponse`](../../doc/models/stored-value-response.md) | Optional | It conveys Information related to the Stored Value transaction processed by the POI System.<br>Content of the Stored Value Response message. | getStoredValueResponse(): ?StoredValueResponse | setStoredValueResponse(?StoredValueResponse storedValueResponse): void |
| `cardAcquisitionResponse` | [`?CardAcquisitionResponse`](../../doc/models/card-acquisition-response.md) | Optional | It conveys Information related to the payment and loyalty cards read and processed by the POI System and entered by the Customer.<br>Content of the Card Acquisition Response message. | getCardAcquisitionResponse(): ?CardAcquisitionResponse | setCardAcquisitionResponse(?CardAcquisitionResponse cardAcquisitionResponse): void |
| `cardReaderAPDUResponse` | [`?CardReaderAPDUResponse`](../../doc/models/card-reader-apdu-response.md) | Optional | Content of the Card Reader APDU Response message.<br>It contains the result of the requested service, APDU response sent by the chip of the card in response to the APDU request. | getCardReaderAPDUResponse(): ?CardReaderAPDUResponse | setCardReaderAPDUResponse(?CardReaderAPDUResponse cardReaderAPDUResponse): void |
...
$repeatedResponseMessageBody = RepeatedResponseMessageBodyBuilder::init()
    ->loyaltyResponse(
