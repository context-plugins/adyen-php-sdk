 ...
 */
class SaleSoftware implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the SaleSoftware object to a human-readable string representation.
     *
     * @return string The string representation of the SaleSoftware object.
     */
