...
```php
use AdyenLib\Models\Builders\PaymentCompletionDetailsBuilder;

$paymentCompletionDetails = PaymentCompletionDetailsBuilder::init()
    ->mD('MD8')
    ->paReq('PaReq8')
    ->paRes('PaRes8')
    ->authorizationToken('authorization_token8')
    ->billingToken('billingToken0')
    ->build();
```
