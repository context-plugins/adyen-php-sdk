...
| `status` | [`string(Status6Enum)`](../../doc/models/status-6-enum.md) | Required | The status you want to change to | getStatus(): string | setStatus(string status): void |
...
```php
use AdyenLib\Models\Builders\StoredValueStatusChangeRequestBuilder;
use AdyenLib\Models\Status6Enum;
use AdyenLib\Models\Builders\AmountBuilder;
use AdyenLib\Models\ShopperInteractionEnum;

$storedValueStatusChangeRequest = StoredValueStatusChangeRequestBuilder::init(
    'merchantAccount8',
    [
        'key0' => 'paymentMethod4'
    ],
