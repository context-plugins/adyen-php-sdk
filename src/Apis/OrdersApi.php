...
use AdyenLib\Models\CancelOrderResponse;
...
class OrdersApi extends BaseApi
{
     ...
     */
    public function postOrders(?string $idempotencyKey = null, ?CreateOrderRequest $body = null): CreateOrderResponse
    {
     ...
     *
     * @return CancelOrderResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function postOrdersCancel(
     ...
     *
     * @return BalanceCheckResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
