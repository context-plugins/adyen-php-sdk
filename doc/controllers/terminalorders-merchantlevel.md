...
```php
function getMerchantsMerchantIdBillingEntities(
    string $merchantId,
    ?string $name = null
...
try {
    $result = $terminalOrdersMerchantLevelApi->getMerchantsMerchantIdBillingEntities($merchantId);
...
try {
    $result = $terminalOrdersMerchantLevelApi->getMerchantsMerchantIdShippingLocations($merchantId);
...
try {
    $result = $terminalOrdersMerchantLevelApi->postMerchantsMerchantIdShippingLocations(
        $merchantId,
        $body
    );
...
```php
function getMerchantsMerchantIdTerminalModels(string $merchantId): TerminalModelsResponse
```
...
try {
    $result = $terminalOrdersMerchantLevelApi->getMerchantsMerchantIdTerminalModels($merchantId);
...
try {
    $result = $terminalOrdersMerchantLevelApi->getMerchantsMerchantIdTerminalOrders($merchantId);
...
try {
    $result = $terminalOrdersMerchantLevelApi->postMerchantsMerchantIdTerminalOrders(
        $merchantId,
        $body
    );
    echo 'TerminalOrder:';
...
```php
function getMerchantsMerchantIdTerminalOrdersOrderId(string $merchantId, string $orderId): TerminalOrder
```
...
try {
    $result = $terminalOrdersMerchantLevelApi->getMerchantsMerchantIdTerminalOrdersOrderId(
        $merchantId,
        $orderId
    );
    echo 'TerminalOrder:';
...
try {
    $result = $terminalOrdersMerchantLevelApi->patchMerchantsMerchantIdTerminalOrdersOrderId(
        $merchantId,
        $orderId,
        $body
    );
...
```php
function postMerchantsMerchantIdTerminalOrdersOrderIdCancel(string $merchantId, string $orderId): TerminalOrder
```
...
try {
    $result = $terminalOrdersMerchantLevelApi->postMerchantsMerchantIdTerminalOrdersOrderIdCancel(
        $merchantId,
        $orderId
    );
    echo 'TerminalOrder:';
...
try {
    $result = $terminalOrdersMerchantLevelApi->getMerchantsMerchantIdTerminalProducts(
        $merchantId,
        $country
    );
