...
$organization1 = Organization1Builder::init(
    'legalName0',
    ...
    ->countryOfGoverningLaw('countryOfGoverningLaw6')
    ->dateOfIncorporation('dateOfIncorporation2')
    ->dateOfInitiationOfLegalProceeding('dateOfInitiationOfLegalProceeding8')
