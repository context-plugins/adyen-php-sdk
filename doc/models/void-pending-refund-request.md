...
```php
use AdyenLib\Models\Builders\VoidPendingRefundRequestBuilder;
...
$voidPendingRefundRequest = VoidPendingRefundRequestBuilder::init(
    'merchantAccount4'
)
    ->additionalData(
        [
    ...
    ->originalMerchantReference('originalMerchantReference6')
