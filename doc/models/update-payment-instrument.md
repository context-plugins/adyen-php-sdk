...
|  --- | --- | --- | --- | --- | --- |
| `additionalBankAccountIdentifications` | [IbanAccountIdentification](../../doc/models/iban-account-identification.md)[]\|null | Optional | This is Array of a container for one-of cases. | getAdditionalBankAccountIdentifications(): ?array | setAdditionalBankAccountIdentifications(?array additionalBankAccountIdentifications): void |
...
| `bankAccount` | [`?BankAccountDetails1`](../../doc/models/bank-account-details-1.md) | Optional | Contains the business account details. Returned when you create a payment instrument with `type` **bankAccount**. | getBankAccount(): ?BankAccountDetails1 | setBankAccount(?BankAccountDetails1 bankAccount): void |
| `card` | [`?Card11`](../../doc/models/card-11.md) | Optional | Contains information about the card payment instrument. Returned when you create a payment instrument with `type` **card**. | getCard(): ?Card11 | setCard(?Card11 card): void |
...
| `id` | `string` | Required | The unique identifier of the payment instrument. | getId(): string | setId(string id): void |
...
| `replacedById` | `?string` | Optional | The unique identifier of the payment instrument that replaced this payment instrument. | getReplacedById(): ?string | setReplacedById(?string replacedById): void |
| `replacementOfId` | `?string` | Optional | The unique identifier of the payment instrument that is replaced by this payment instrument. | getReplacementOfId(): ?string | setReplacementOfId(?string replacementOfId): void |
...
```php
use AdyenLib\Models\Builders\UpdatePaymentInstrumentBuilder;
...
$updatePaymentInstrument = UpdatePaymentInstrumentBuilder::init(
    'balanceAccountId0',
    'id8',
    'issuingCountryCode0',
