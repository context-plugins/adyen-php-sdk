 ...
 */
class Target1 implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the Target1 object to a human-readable string representation.
     *
     * @return string The string representation of the Target1 object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('Target1', ['id' => $this->id, 'type' => $this->type]);
    }
