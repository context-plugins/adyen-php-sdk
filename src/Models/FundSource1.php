 ...
 */
class FundSource1 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the FundSource1 object to a human-readable string representation.
     *
     * @return string The string representation of the FundSource1 object.
     */
