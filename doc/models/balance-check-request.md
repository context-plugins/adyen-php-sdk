...
```php
use AdyenLib\Models\Builders\BalanceCheckRequestBuilder;
...
use AdyenLib\Models\Builders\Address1Builder;

$balanceCheckRequest = BalanceCheckRequestBuilder::init(
    Amount2Builder::init(
        'currency2',
        110
    )->build(),
