...
```php
function getCompaniesCompanyIdTerminalLogos(string $companyId, string $model): Logo
```
...
try {
    $result = $terminalSettingsCompanyLevelApi->getCompaniesCompanyIdTerminalLogos(
        $companyId,
        $model
    );
    echo 'Logo:';
...
```php
function patchCompaniesCompanyIdTerminalLogos(string $companyId, string $model, ?Logo $body = null): Logo
```
...
try {
    $result = $terminalSettingsCompanyLevelApi->patchCompaniesCompanyIdTerminalLogos(
        $companyId,
        $model,
        $body
    );
...
```php
function getCompaniesCompanyIdTerminalSettings(string $companyId): TerminalSettings
```
...
try {
    $result = $terminalSettingsCompanyLevelApi->getCompaniesCompanyIdTerminalSettings($companyId);
...
```php
function patchCompaniesCompanyIdTerminalSettings(
    string $companyId,
...
try {
    $result = $terminalSettingsCompanyLevelApi->patchCompaniesCompanyIdTerminalSettings(
        $companyId,
        $body
    );
    echo 'TerminalSettings:';
