...
try {
    $result = $modificationsApi->postCancels(
        null,
        $body
    );
...
try {
    $result = $modificationsApi->postPaymentsPaymentPspReferenceAmountUpdates(
        $paymentPspReference,
        null,
        $body
    );
...
try {
    $result = $modificationsApi->postPaymentsPaymentPspReferenceCancels(
        $paymentPspReference,
        null,
        $body
    );
...
try {
    $result = $modificationsApi->postPaymentsPaymentPspReferenceCaptures(
        $paymentPspReference,
        null,
        $body
    );
...
try {
    $result = $modificationsApi->postPaymentsPaymentPspReferenceRefunds(
        $paymentPspReference,
        null,
        $body
    );
...
try {
    $result = $modificationsApi->postPaymentsPaymentPspReferenceReversals(
        $paymentPspReference,
        null,
        $body
    );
...
```php
function postAdjustAuthorisation(?AdjustAuthorisationRequest $body = null): ModificationResult
```
...
```php
$body = AdjustAuthorisationRequestBuilder::init(
    'YOUR_MERCHANT_ACCOUNT',
    AmountBuilder::init(
        'USD',
        1700
...
try {
    $result = $modificationsApi->postAdjustAuthorisation($body);
    echo 'ModificationResult:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
} catch (ApiException $exp) {
...
```php
function postCancel(?CancelRequest $body = null): ModificationResult
```
...
```php
$body = CancelRequestBuilder::init(
    'YOUR_MERCHANT_ACCOUNT',
    'COPY_PSP_REFERENCE_FROM_AUTHORISE_RESPONSE'
)
    ->reference('YourModificationReference')
...
try {
    $result = $modificationsApi->postCancel($body);
    echo 'ModificationResult:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
...
```php
function postCancelOrRefund(?CancelOrRefundRequest $body = null): ModificationResult
```
...
```php
$body = CancelOrRefundRequestBuilder::init(
    'YOUR_MERCHANT_ACCOUNT',
    'COPY_PSP_REFERENCE_FROM_AUTHORISE_RESPONSE'
)
    ->reference('YourModificationReference')
...
try {
    $result = $modificationsApi->postCancelOrRefund($body);
    echo 'ModificationResult:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
...
```php
function postCapture(?CaptureRequest $body = null): ModificationResult
```
...
try {
    $result = $modificationsApi->postCapture($body);
    echo 'ModificationResult:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
...
```php
function postDonate(?DonationRequest $body = null): ModificationResult
```
...
```php
$body = DonationRequestBuilder::init(
    'AdyenGivingDemo',
    'YOUR_MERCHANT_ACCOUNT',
    AmountBuilder::init(
        'EUR',
...
try {
    $result = $modificationsApi->postDonate($body);
    echo 'ModificationResult:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
...
```php
function postRefund(?RefundRequest $body = null): ModificationResult
```
...
try {
    $result = $modificationsApi->postRefund($body);
    echo 'ModificationResult:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
...
```php
function postTechnicalCancel(?TechnicalCancelRequest $body = null): ModificationResult
```
...
```php
$body = TechnicalCancelRequestBuilder::init(
    'YOUR_MERCHANT_ACCOUNT',
...
try {
    $result = $modificationsApi->postTechnicalCancel($body);
    echo 'ModificationResult:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
...
```php
function postVoidPendingRefund(?VoidPendingRefundRequest $body = null): ModificationResult
```
...
```php
$body = VoidPendingRefundRequestBuilder::init(
    'YOUR_MERCHANT_ACCOUNT'
)
...
try {
    $result = $modificationsApi->postVoidPendingRefund($body);
    echo 'ModificationResult:';
    var_dump($result);
} catch (ServiceErrorException $exp) {
    echo 'Caught ServiceErrorException:', $exp;
