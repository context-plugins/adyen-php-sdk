...
```php
use AdyenLib\Models\Builders\StoredValueBalanceCheckResponseBuilder;
use AdyenLib\Models\Builders\AmountBuilder;
use AdyenLib\Models\ResultCode3Enum;

$storedValueBalanceCheckResponse = StoredValueBalanceCheckResponseBuilder::init()
    ->currentBalance(
        AmountBuilder::init(
            'currency2',
            232
    ...
    ->thirdPartyRefusalReason('thirdPartyRefusalReason6')
    ->build();
```
