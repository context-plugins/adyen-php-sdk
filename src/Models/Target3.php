 ...
 */
class Target3 implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the Target3 object to a human-readable string representation.
     *
     * @return string The string representation of the Target3 object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('Target3', ['id' => $this->id, 'type' => $this->type]);
    }
