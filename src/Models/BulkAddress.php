...
class BulkAddress implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the BulkAddress object to a human-readable string representation.
     *
     * @return string The string representation of the BulkAddress object.
     */
