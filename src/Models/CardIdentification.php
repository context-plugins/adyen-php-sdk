...
class CardIdentification implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the CardIdentification object to a human-readable string representation.
     *
     * @return string The string representation of the CardIdentification object.
     */
