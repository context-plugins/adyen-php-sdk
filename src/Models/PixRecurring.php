...
class PixRecurring implements \JsonSerializable
{
     ...
     *
     * @maps frequency
     * @factory \AdyenLib\Models\Frequency2Enum::checkValue
     */
     ...
     */
    public function getMinAmount(): ?Amount42
    {
     ...
     * @maps minAmount
     */
    public function setMinAmount(?Amount42 $minAmount): void
    {
     ...
     */
    public function getRecurringAmount(): ?Amount43
    {
     ...
     */
    public function setRecurringAmount(?Amount43 $recurringAmount): void
    {
