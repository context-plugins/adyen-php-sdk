 ...
 */
class MerchantRiskIndicator11 implements \JsonSerializable
{
    /**
     * @var bool|null
     */
     ...
     * @factory \AdyenLib\Models\DeliveryAddressIndicatorEnum::checkValue
     */
     ...
     * @factory \AdyenLib\Models\DeliveryTimeframeEnum::checkValue
     */
     ...
     */
    public function getGiftCardAmount(): ?Amount
    {
     ...
     * @maps giftCardAmount
     */
    public function setGiftCardAmount(?Amount $giftCardAmount): void
    {
    ...
    /**
     * Converts the MerchantRiskIndicator11 object to a human-readable string representation.
     *
     * @return string The string representation of the MerchantRiskIndicator11 object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->deliveryAddressIndicator)) {
            $json['deliveryAddressIndicator'] =
                DeliveryAddressIndicatorEnum::checkValue(
                    $this->deliveryAddressIndicator
                );
        }
        ...
        if (isset($this->deliveryTimeframe)) {
            $json['deliveryTimeframe']        = DeliveryTimeframeEnum::checkValue($this->deliveryTimeframe);
        }
