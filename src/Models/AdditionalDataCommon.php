...
class AdditionalDataCommon implements \JsonSerializable
{
     ...
     *
     * @maps industryUsage
     * @factory \AdyenLib\Models\IndustryUsageEnum::checkValue
     */
     ...
     * Allows you to link the transaction to the original or previous one in a subscription/card-on-file
     * chain For Mastercard payments. This field is required for token-based transactions where Adyen does
     * not tokenize the card.
     *
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->industryUsage)) {
            $json['industryUsage']                     = IndustryUsageEnum::checkValue($this->industryUsage);
        }
