...
```php
function getMe(): MeApiCredential
```
...
try {
    $result = $myAPICredentialApi->getMe();
...
```php
function getMeAllowedOrigins(): AllowedOriginsResponse
```
...
try {
    $result = $myAPICredentialApi->getMeAllowedOrigins();
...
```php
function postMeAllowedOrigins(?CreateAllowedOriginRequest $body = null): AllowedOrigin
```
...
try {
    $result = $myAPICredentialApi->postMeAllowedOrigins($body);
    echo 'AllowedOrigin:';
    var_dump($result);
} catch (RestServiceErrorException $exp) {
    echo 'Caught RestServiceErrorException:', $exp;
...
```php
function getMeAllowedOriginsOriginId(string $originId): AllowedOrigin
```
...
try {
    $result = $myAPICredentialApi->getMeAllowedOriginsOriginId($originId);
    echo 'AllowedOrigin:';
    var_dump($result);
} catch (RestServiceErrorException $exp) {
    echo 'Caught RestServiceErrorException:', $exp;
...
```php
function deleteMeAllowedOriginsOriginId(string $originId): void
```
...
try {
    $myAPICredentialApi->deleteMeAllowedOriginsOriginId($originId);
} catch (RestServiceErrorException $exp) {
    echo 'Caught RestServiceErrorException:', $exp;
} catch (ApiException $exp) {
    echo 'Caught:', $exp;
...
```php
function postMeGenerateClientKey(): GenerateClientKeyResponse
```
...
try {
    $result = $myAPICredentialApi->postMeGenerateClientKey();
