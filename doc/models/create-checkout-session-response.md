...
| `id` | `string` | Required, Read-only | A unique identifier of the session. | getId(): string | setId(string id): void |
...
```php
use AdyenLib\Models\Builders\CreateCheckoutSessionResponseBuilder;
...
$createCheckoutSessionResponse = CreateCheckoutSessionResponseBuilder::init(
